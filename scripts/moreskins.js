CoolClock.config.skins = {
	...
	Saw: {
		...
		hourHand:         { lineWidth: 4, startAt: 0, endAt: 65, color: "white", alpha: 0.9 },
		minuteHand:       { lineWidth: 3, startAt: 0, endAt: 80, color: "white", alpha: 0.85 },
		secondHand:       { lineWidth: 1, startAt: 0, endAt: 85, color: "#00FF33", alpha: 1 },
		secondDecoration: { lineWidth: 2, startAt: 5, radius: 10, fillColor: "black", color: "#CCFF33", alpha: 1 }
	},
