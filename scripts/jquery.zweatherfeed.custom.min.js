...
"</div>",b+="</div>";b+="</div>"}e.link&&(b+='<div class="weatherLink">&nbsp;</div>')}else b='<div class="weatherItem '+m+'">',b+='<div class="weatherError">City not found</div>';b+="</div>";m="odd"==m?"even":"odd";f.append(b)},v=function(f){d=new Date;return r=new Date(d.toDateString()+" "+f)}})}})(jQuery);