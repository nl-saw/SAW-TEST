<h2 class="content-heading">Staying in touch!</h2>
...
<form name="contact" class="contact-form" action="javascript:sendMessage()" method="post">
  ...
  <p>
    <label> Subject:*<br>
      <input id="contact_subject" onblur="validateText($(this).attr('id'))" style="color:#777" type="text" class="text validinput" name="subject" size="30" value="Message From O.S Template" readonly="readonly" />
    </label>
  </p>
  <p>
    <label> Message:*<br>
